...
function Login() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0a", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px", position: "relative" }}>
      ...
      <div style={{ width: "100%", maxWidth: "380px", position: "relative", zIndex: 2, animation: "fadeInUp 0.5s cubic-bezier(0.16,1,0.3,1) forwards" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          <h1 style={{ fontSize: "28px", fontWeight: "800", letterSpacing: "-0.5px", color: "#fff" }}>Affinity Hub</h1>
          <p style={{ color: "rgba(255,255,255,0.35)", marginTop: "6px", fontSize: "14px" }}>Find your perfect match</p>
        </div>
        ...
        <button onClick={handleLogin} disabled={loading} className="btn" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px" }}>
        ...
        <Link to="/register" className="btn-outline" style={{ display: "block", textAlign: "center", textDecoration: "none" }}>
          Create new account
        </Link>

        <p style={{ textAlign: "center", marginTop: "32px", color: "rgba(255,255,255,0.15)", fontSize: "11px", letterSpacing: "1.5px", textTransform: "uppercase" }}>
